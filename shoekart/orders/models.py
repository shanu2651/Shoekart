...
class Order(models.Model):
    owners=models.ForeignKey(Customer,on_delete=models.SET_NULL,null=True,related_name='orders')
    CART_STAGE=0
    ORDER_CONFIRMED=1
    ORDER_PROCESSED=2
    ORDER_DELIVERED=3
...
class OrderedItem(models.Model):
    ...
    owners=models.ForeignKey(Order,on_delete=models.CASCADE,related_name='ordered_items')    
